    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-sm text-slate-400 mt-0.5">Your emotional patterns at a glance.</p>
        </div>
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            {[0, 1].map((i) => (
              <div key={i} className="bg-white border border-slate-200 rounded-xl p-5 h-48 animate-pulse">
